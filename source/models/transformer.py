...
class GraphTransformer(BaseModel):
    ...
    def forward_features(self, time_seires, node_feature):
        ...
        # Return features before last Linear
        x = torch.nn.functional.leaky_relu(self.fc[0](node_feature), 0.2)
        x = torch.nn.functional.leaky_relu(self.fc[2](x), 0.2)
        return x
