...
ax.errorbar(k_sgd, bnt_auc, yerr=bnt_sem,
            ...
            linestyle="--", label="BNT-TTA (SGD fine-tuning)", zorder=3)
...
ax.errorbar(k_maml, maml_auc, yerr=maml_sem,
            ...
            markersize=7, capsize=4, capthick=1.5, elinewidth=1.5,
            linestyle="-", label="BNT-MAML-TTA (ours)", zorder=4)
...
# k=0 au point 0 (intersection axes)
ax.set_xlim(0, 16)
ax.set_ylim(66, 76)
...
plt.tight_layout()
plt.savefig("figures/fig_data_efficiency_final.pdf",
            dpi=300, bbox_inches="tight")
plt.savefig("figures/fig_data_efficiency_final.png",
            dpi=300, bbox_inches="tight")
